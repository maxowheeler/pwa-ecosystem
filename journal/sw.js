// journal-sw.js — Service worker for the Journal PWA
// Network-first for HTML (always fresh), cache-first for JS/CSS assets.
// Deploy to: /home/shyguy/apps/journal/sw.js

const CACHE_NAME = 'journal-v3';

const PRECACHE = [
  '/journal/index.html',
  '/journal/viewall.html',
  '/journal/journal.js',
  '/journal/journal.css',
  '/journal/viewall.js',
  '/shared/theme.css',
...
const HTML_FILES = ['/journal/index.html', '/journal/viewall.html'];
